...
namespace KO.Core.Extensions
{
    ...
    public static class EnumExtensions
    {
        ...
        public static List<EnumModel> List(this Enum value)
        {
            var data = value.GetType().GetFields()
                .Where(x => x.IsStatic)
                .Select(x => new
                {
                    Data = x,
        ...
        public static List<EnumAttributeModel<T>> List<T>(this Enum value) where T : Attribute
        {
            var data = value.GetType().GetFields()
                .Where(x => x.IsStatic)
                .Select(x => new
        ...
        public static List<string> StringList(this Enum value)
        {
            return Enum.GetValues(value.GetType()).Cast<Enum>().Select(x => x.ToString()).ToList();
        }

        public static List<Enum> All(this Enum value)
        {
