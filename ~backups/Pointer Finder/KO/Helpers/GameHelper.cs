...
namespace KO.Helpers
{
    public class GameHelper : WinApiHelper
    {
        ...
        public List<Models.AddressItem> Addresses = new List<Models.AddressItem>()
        {
            ...
            new Models.AddressItem(){ Active = true, Name = "KO_OTO_LOGIN_01",         Start = DefaultStart,  Length = DefaultLength, Type = Enums.AddressType.CallAdd,   Hex = "75XX837C24XXXX0F85QQQQXXXX85C974", CallOffset = 0x20 },
            ...
            new Models.AddressItem(){ Active = true, Name = "KO_FAKE_ITEM",            Start = DefaultStart,  Length = DefaultLength, Type = Enums.AddressType.CallAdd,   Hex = "6AFF68QQ64A1QQ5051555657A1QQ33C4508D4424XX64A3QQ8BF18B6C24XX85ED", CallOffset = 0x2C },
            new Models.AddressItem(){ Active = true, Name = "KO_SUB_ADDR0",            Start = DefaultStart,  Length = DefaultLength, Type = Enums.AddressType.CallAdd,   Hex = "5081ECA0020000A1QQ33C489842498020000535657A1QQ33C4508D8424", CallOffset = 0x36 },
            ...
            new Models.AddressItem(){ Active = true, Name = "KO_SMMB",                 Start = 0x500000,      Length = DefaultLength, Type = Enums.AddressType.Pointer,   Hex = "B9QQ518B0D" },
            ...
            new Models.AddressItem(){ Active = true, Name = "KO_MERC_PACKET",          Start = DefaultStart,  Length = DefaultLength, Type = Enums.AddressType.CallAdd,   Hex = "83ECXXA1QQ33C4894424XX80B9", CallOffset = 0x10 },
            new Models.AddressItem(){ Active = true, Name = "KO_MERC_CLOSE",           Start = DefaultStart,  Length = DefaultLength, Type = Enums.AddressType.CallAdd,   Hex = "A1{0}8B80QQ33DB8BE9894424", BasePointer = "KO_PTR_DLG", CallOffset = 0x44 },
            new Models.AddressItem(){ Active = true, Name = "KO_MERC_MYBUYITEMS",      Start = DefaultStart,  Length = DefaultLength, Type = Enums.AddressType.Pointer,   Hex = "BEQQ33D233DBC1E9XXF7F6BE" },
            #endregion
            #region [Offset]
            ...
            new Models.AddressItem(){ Active = true, Name = "KO_OFF_BANKB",            Start = DefaultStart,  Length = DefaultLength, Type = Enums.AddressType.Pointer,   Hex = "A1QQ01A8QQC68424", BasePointer = "KO_PTR_DLG" },
            ...
            new Models.AddressItem(){ Active = true, Name = "KO_OFF_MERC_WINDOW",      Start = DefaultStart,  Length = DefaultLength, Type = Enums.AddressType.Pointer,   Hex = "6AXX8BCEE8QQ85C075XX8BCFE8QQ8B8F" },
            new Models.AddressItem(){ Active = true, Name = "KO_OFF_MERC_REMAIN",      Start = DefaultStart,  Length = DefaultLength, Type = Enums.AddressType.Pointer,   Hex = "A1{0}83B8QQXX745D8B88", BasePointer = "KO_PTR_DLG" },
            #endregion
        };
